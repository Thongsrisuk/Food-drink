...
async function getMealsByCategory(category) {
 ...
 if (category.toLowerCase() === 'beverage') {
            return [
                { strMeal: "Americano", strMealThumb: "Beverages/americano.jpeg", idMeal: "c1" },
                { strMeal: "Coffee", strMealThumb: "Beverages/coffee.jpg", idMeal: "c2" },
                { strMeal: "Expresso", strMealThumb: "Beverages/expresso.jpg", idMeal: "c3" },
                { strMeal: "Latte", strMealThumb: "Beverages/latte.jpg", idMeal: "c4" },
                { strMeal: "Softdrink", strMealThumb: "Beverages/softdrink.jpg", idMeal: "c5" },
                { strMeal: "Smoothie", strMealThumb: "Beverages/Smoothie.jpg", idMeal: "c6" },
            ];
        }
